...
const ImagePlaceholder: React.FunctionComponent<TImagePlaceholder> = ({ alignment, imageWrapperSize, imageSize }) => {
  return (
    <div
      role='status'
      className={cn(
    ...
    >
      ...
      >
        <svg
          className={cn('w-10 h-10 text-gray-200 dark:text-gray-600', imageSize)}
          aria-hidden='true'
